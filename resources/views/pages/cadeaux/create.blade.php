...
@section('title', 'Nouveau Cadeau/Invitation')
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h4><i class="fas fa-gift"></i> Nouveau Cadeau/Invitation</h4>
                        ...
                        <div class="card-body">
                            <form action="{{ route('cadeau-invitations.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror"
                                                value="{{ old('nom') }}" placeholder="Ex: Invitation conférence" required>
                                            @error('nom')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cadeau_hospitalite" class="form-control @error('cadeau_hospitalite') is-invalid @enderror"
                                        value="{{ old('cadeau_hospitalite') }}" placeholder="Ex: Dîner d'affaires, Cadeau promotionnel..." required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="valeurs" class="form-control @error('valeurs') is-invalid @enderror"
                                                value="{{ old('valeurs') }}" step="0.01" min="0" placeholder="0.00">
                                            @error('valeurs')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="action_prise" class="form-control select2 @error('action_prise') is-invalid @enderror" required>
                                                ...
                                                <option value="accepté" {{ old('action_prise') == 'accepté' ? 'selected' : '' }}>Accepté</option>
                                                <option value="refusé" {{ old('action_prise') == 'refusé' ? 'selected' : '' }}>Refusé</option>
                                                <option value="en_attente" {{ old('action_prise') == 'en_attente' ? 'selected' : '' }}>En attente</option>
                                            </select>
                                            @error('action_prise')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                        rows="4" placeholder="Description détaillée du cadeau ou de l'invitation...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
